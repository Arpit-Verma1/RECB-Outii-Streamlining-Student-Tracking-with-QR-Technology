...
class _user_dataState extends State<user_data> {
  ...
  Widget listItem({required Map student}) {
    ...
    return Center(
      child: Visibility(
          visible: student['Name'] == "$Name$g$Branch",
          child: Column(
        ...
        body: show == false
            ? Container(
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      "Fill Your Mobile Number To Generate QR Code And See Your Details",
                      style: TextStyle(
                          fontWeight: FontWeight.bold,
                          fontSize: 20,
                          color: Colors.black),
            ...
            : Center(
                child: Container(
                  margin: EdgeInsets.only(
                      top: 180, bottom: 50, left: 20, right: 20),
