...
TextStyle regLobster = TextStyle(color: Colors.black, fontSize: 20,fontFamily: 'Lobster');
TextStyle bigLobster = TextStyle(
    wordSpacing: 2, fontSize: 30, color: Colors.white, letterSpacing: 2,fontFamily: 'Lobster');
