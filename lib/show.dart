...
class _FetchDataState extends State<FetchData> {
  ...
  Widget listItem({required Map student}) {
    ...
    a.contains(controller1.text.toLowerCase()),
      ...
      height: 35,
      decoration: BoxDecoration( color: "${student['Timeout'].toString()}"=="0"?Colors.red:Colors.green,
                            ...
                            SizedBox(width: size.width*0.7,
                                ...
                                TextField(
                                  ...
                                  decoration: new InputDecoration(
                                    ...
                                    contentPadding:
                                    EdgeInsets.only(top: 10,bottom: 10),prefixIcon: IconButton(icon: Icon(Icons.search,color: Colors.white,), onPressed: () { setState(() {
//print(b2);
                                    }); },),
                                    filled: false,
                            ...
                            AvatarGlow(  animate:islistening, endRadius:30,glowColor: Colors.white,showTwoGlows: true,
                              child:
                              SizedBox(
  ...
  Future togglerecording()=>Speechapi.togglerecording(onresult:  (text)=>setState(()=>this.controller1.text=text,),
