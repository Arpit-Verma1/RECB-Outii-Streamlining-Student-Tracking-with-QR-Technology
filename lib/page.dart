...
class _Page1State extends State<Page1> {
  ...
  bool show=false;
  bool show1=false;String Branch="";
  String Name="";
  bool isPlaying = false;
  String s="";
  DatabaseReference _dbref=FirebaseDatabase.instance.ref();
  int c=0;int d=0;int f=0;int g=0;int e=0;
String phone="";
            ...
            Column(
              children: [
                ...
                Row(
                    children: [
                      ElevatedButton(
                          onPressed: (){setState((){bed=0;
                        k="Market";  show1=false;
                      });},child:Text("Market"),style:ElevatedButton.styleFrom(primary: bed==0?Colors.green:Colors.blue),),
                      SizedBox(width: size.width*0.03,),

                      ElevatedButton(onPressed:  (){setState((){bed=1;k="Jannat";
                      show1=false;});},child:Text("Jannat"),
                        style:ElevatedButton.styleFrom(primary: bed==1?Colors.green:Colors.blue),),
                      SizedBox(width: size.width*0.03,),
                    ElevatedButton(onPressed:(){setState((){bed=2;k="Home";  show1=false;});},child:Text("Home"),
                      style:ElevatedButton.styleFrom(primary: bed==2?Colors.green:Colors.blue),),
                SizedBox(width: size.width*0.03,) ,ElevatedButton(onPressed: (){setState((){bed=3;k="Bank";  show1=false;});},child:Text("Bank"),
                        style:ElevatedButton.styleFrom(primary: bed==3?Colors.green:Colors.blue),),
            SizedBox(width: size.width*0.03,)
                      ,  ElevatedButton(onPressed: (){setState((){bed=4;
                      show1=!show1;});},child:Text("Anything Else"),
                        style:ElevatedButton.styleFrom(primary: bed==4?Colors.green:Colors.blue),),
                      SizedBox(width: size.width*0.03,),
                    ]),)
          ...
          Center(
              ...
              child: Container(padding: EdgeInsets.all(10),
                ...
                Column(
                  ...
                  children: <Widget>[ ConfettiWidget(confettiController: controller2,
                      shouldLoop: true,
                    ...
                    ConfettiWidget(confettiController: controller2,
                        shouldLoop: true,
                        emissionFrequency: 0.08,
                        gravity: 0.3,
                        blastDirection: 0,
  ...
  _createdb(){
    ...
    _dbref.child('Students').child("$Name$g$Branch").update({'Name':"$Name$g$Branch",'Timein':"--",'Timeout':"--",'Phone':"$phone",'Where':"--"});
